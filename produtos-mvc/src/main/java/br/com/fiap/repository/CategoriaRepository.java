...
public class CategoriaRepository {
	...
	public List<CategoriaModel> findAll() {
		...
		List<CategoriaModel> categorias = this.jdbcTemplate.query(FIND_ALL, new BeanPropertyRowMapper<CategoriaModel>(CategoriaModel.class));
		return categorias;
	}

	public CategoriaModel findById(long id) {

		CategoriaModel categoria = this.jdbcTemplate.queryForObject(FIND_BY_ID, new BeanPropertyRowMapper<CategoriaModel>(CategoriaModel.class), id);
		return categoria;
	}
